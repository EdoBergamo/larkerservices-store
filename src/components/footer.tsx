                    ...
                    {pathsToMinimize.includes(pathname) ? null : (
                        <div className="pb-8 pt-16">
                            <div className="flex justify-center">
                                <Image src='/logo.png' height='48' width='48' className="h-12 w-auto" alt="LarkerServices" />
                            </div>
                        </div>
                    )}
                        ...
                        <div>
                            <div className="relative flex items-center px-6 py-6 sm:py-8 lg:mt-0">
                                ...
                                <div className="text-center relative mx-auto max-w-sm">
                                    <h3 className="font-semibold text-gray-900">Become a Reseller</h3>
                                    <p className="mt-2 text-sm text-muted-foreground">
                                        If you&apos;d like to sell high-quality
                                        cheats, you can do so in minutes.{' '}
                                        <Link href='/login?as=reseller' className="whitespace-nowrap font-medium text-black hover:text-zinc-900">
                                            Get started &rarr;
                                        </Link>
                                    </p>
                                </div>
